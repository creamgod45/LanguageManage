...
return [
    ...
    */
    ...
    'after_or_equal' => ':attribute 必须是在 :date 之后或相同的日期。',
    'alpha' => ':attribute 只能由字母组成。',
    'alpha_dash' => ':attribute 只能由字母、数字、破折号 (dash) 和下划线 (underscore) 组成。',
    'alpha_num' => ':attribute 只能由字母和数字组成。',
    'any_of' => ':attribute 无效。',
    'array' => ':attribute 必须是一个数组。',
    'ascii' => ':attribute 只能包含单字节的字母、数字和符号。',
    'before' => ':attribute 必须是在 :date 之前的日期。',
    'before_or_equal' => ':attribute 必须是在 :date 之前或相同的日期。',
    'between' => [
    ...
    'digits_between' => ':attribute 必须介於 :min 至 :max 位数字之间。',
    'dimensions' => ':attribute 图片尺寸无效。',
    'distinct' => ':attribute 字段具有重复值。',
    'doesnt_contain' => ':attribute 不能包含以下内容：:values。',
    'doesnt_end_with' => ':attribute 不能以下列其中一项结尾：:values。',
    'doesnt_start_with' => ':attribute 不能以下列其中一项开头：:values。',
