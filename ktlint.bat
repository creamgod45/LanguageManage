...
C:\Users\v_ken.wang\.jdks\jbr-17.0.14\bin\java.exe --add-opens=java.base/java.lang=ALL-UNNAMED -jar "%JAR_PATH%" %*

REM With Java24+
REM Suppress warning "sun.misc.Unsafe::objectFieldOffset" on Java24+ (https://github.com/pinterest/ktlint/issues/2973)
REM C:\Users\v_ken.wang\.jdks\jbr-17.0.14\bin\java.exe --sun-misc-unsafe-memory-access=allow -jar "%JAR_PATH%" %*
