...
LanguageManager `1.5.2` uses the following plugin descriptor settings:
...
## Marketplace Verification Results for 1.5.1

JetBrains Marketplace Compatibility Verification reported the following LanguageManager `1.5.1` results on July 16, 2026:

| Status | Product | Version | Date and time | Verifier | Verdict |
|---|---|---|---|---|---|
| Success | IntelliJ IDEA | 2026.2 RC (`262.8665.176`) | 2026-07-16 11:27 | IDE | No issues occurred during an IDE run with the plugin installed |
...
| Warning | IntelliJ IDEA | 2026.1 | 2026-07-16 11:26 | Plugin Verifier `1.408` | Compatible; 91 usages of experimental API |
| Warning | PhpStorm | 2026.1 | 2026-07-16 11:27 | Plugin Verifier `1.408` | Compatible; 91 usages of experimental API |
...
`Compatible` means Plugin Verifier found no binary compatibility failure for that IDE version. The 2026.1 warning rows remain compatible, but report 91 experimental API usages whose contracts may change in later IDE releases. An actual IDE run and Plugin Verifier are separate checks.
