...
| Marketplace package size | 1.32 MB |
| Uploaded by | Laifu來福（來福Laifu） |
| Version downloads at report time | 0 |

## Marketplace verification results for 1.5.6

JetBrains Marketplace Compatibility Verification reported the following LanguageManager `1.5.6` results on August 5, 2026:

| Status | Product | Version | Date and time | Verifier | Verdict |
|---|---|---|---|---|---|
| Success | IntelliJ IDEA | 2026.2.1 RC (`262.9437.65`) | 2026-08-05 17:43 | IDE | No issues occurred during an IDE run with the plugin installed |
| Warning | IntelliJ IDEA | 2026.2.1 RC (`262.9437.65`) | 2026-08-05 17:37 | Plugin Verifier `1.408` | Compatible; 1 experimental API usage |
| Warning | IntelliJ IDEA | 2026.2.0.1 | 2026-08-05 17:44 | Plugin Verifier `1.408` | Compatible; 1 experimental API usage |
| Warning | IntelliJ IDEA | 2026.2 | 2026-08-05 17:45 | Plugin Verifier `1.408` | Compatible; 1 experimental API usage |
| Warning | IntelliJ IDEA | 2026.1.4 | 2026-08-05 17:37 | Plugin Verifier `1.408` | Compatible; 3 experimental API usages |
| Warning | IntelliJ IDEA | 2026.1.3 | 2026-08-05 17:44 | Plugin Verifier `1.408` | Compatible; 3 experimental API usages |
| Warning | IntelliJ IDEA | 2026.1.2 | 2026-08-05 17:44 | Plugin Verifier `1.408` | Compatible; 3 experimental API usages |
| Warning | IntelliJ IDEA | 2026.1.1 | 2026-08-05 17:44 | Plugin Verifier `1.408` | Compatible; 3 experimental API usages |
| Warning | IntelliJ IDEA | 2026.1 | 2026-08-05 17:44 | Plugin Verifier `1.408` | Compatible; 146 experimental API usages |
| Warning | IntelliJ IDEA | 2025.3.6.1 | 2026-08-05 17:36 | Plugin Verifier `1.408` | Compatible; 10 experimental API usages |

Every listed IDE version is compatible with LanguageManager `1.5.6`, and the standalone IDE run completed successfully on 2026.2.1 RC. Plugin Verifier reported experimental API usages ranging from 1 to 146 depending on the IDE version, but no binary incompatibility.

## Marketplace release status for 1.5.5
...
| Compatibility range | `253.5+` |
| Marketplace package size | 1012.84 KB |
| Uploaded by | Laifu來福（來福Laifu） |
| Version downloads at report time | 0 |

## Marketplace verification results for 1.5.5

JetBrains Marketplace Compatibility Verification reported the following LanguageManager `1.5.5` results on July 28, 2026:

| Status | Product | Version | Date and time | Verifier | Verdict |
|---|---|---|---|---|---|
| Success | IntelliJ IDEA | 2026.2.1 EAP (`262.9437.22`) | 2026-07-28 09:55 | IDE | No issues occurred during an IDE run with the plugin installed |
...
| Warning | IntelliJ IDEA | 2026.1 | 2026-07-28 09:52 | Plugin Verifier `1.408` | Compatible; 113 experimental API usages |
| Success | IntelliJ IDEA | 2025.3.6 | 2026-07-28 09:50 | Plugin Verifier `1.408` | Compatible |

Every listed IDE version is compatible with LanguageManager `1.5.5`. The standalone IDE run also completed successfully on 2026.2.1 EAP. Only the unpatched 2026.1 build reports experimental API usages; the report contains no binary incompatibility or internal API warning.
