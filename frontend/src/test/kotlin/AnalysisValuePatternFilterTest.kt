...
class AnalysisValuePatternFilterTest {
    ...
    fun `recognizes each selectable naming convention independently`() {
        ...
        assertTrue(AnalysisValuePatternFilter.PHP_VARIABLE.matches("${'$'}submitForm"))
        assertTrue(AnalysisValuePatternFilter.PHP_VARIABLE.matches("${'$'}{submit_form}"))
        assertTrue(AnalysisValuePatternFilter.PHP_VARIABLE.matches("{{ ${'$'}id }}"))
        assertTrue(AnalysisValuePatternFilter.PHP_VARIABLE.matches("{{ ${'$'}id }}-hint"))
        assertTrue(AnalysisValuePatternFilter.PHP_VARIABLE.matches("cg-filedrop {{ ${'$'}layout->cssClass() }}"))
        assertTrue(AnalysisValuePatternFilter.PHP_VARIABLE.matches("{{ implode(',', ${'$'}settings['accept']) }}"))
        assertTrue(AnalysisValuePatternFilter.PHP_VARIABLE.matches("{!! ${'$'}html !!}"))
        assertFalse(AnalysisValuePatternFilter.PHP_VARIABLE.matches("{{ 'Static label' }}"))
        assertFalse(AnalysisValuePatternFilter.PHP_VARIABLE.matches("Submit form"))
